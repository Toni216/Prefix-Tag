...
- **Admin commands**: admins can assign, change, reset tiers, set name colors and toggle the online indicator at any time
...
| `/tier online <player> <true\|false>` | Op level 2 | Toggle the green ● indicator left of the prefix |
...
## License
This mod is part of the **Toni's Mods** project and is intended for use on CipolloLand. MIT License
